...
mercedes = SportCar(130, 'Grey', 'Mercedes', False)
niva = TownCar(30, 'Blue', 'Niva', False)
granta = WorkCar(70, 'Yellow', 'Granta', True)
kia = PoliceCar(110, 'White',  'kia', True)
print(granta.turn_left())
print(f'When {niva.turn_right()}, then {mercedes.stop()}')
